...
@Entity
@Table(name = "DI_COSTANALYSIS_AVERAGE")
public class DiCostanalysisAverage implements Serializable {
    @EmbeddedId
    private DiCostanalysisAverageId id;
    ...
    public DiCostanalysisAverageId getId() {
        return id;
    }

    public void setId(DiCostanalysisAverageId id) {
        this.id = id;
    }
    ...
    @Basic
    @Column(name = "ACTUALREQQTY", nullable = true, precision = 5)

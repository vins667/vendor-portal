...
@Entity
@Table(name = "DI_STOCKTRANSACTIONISSUE")
public class DiStocktransactionissue {
    @EmbeddedId
    private DiStocktransactionissueId id;
    ...
    public DiStocktransactionissueId getId() {
        return id;
    }

    public void setId(DiStocktransactionissueId id) {
        this.id = id;
    }
    ...
    @Basic
    @Column(name = "ITEMTYPECOMPANYCODE")
    ...
    @Basic
    @Column(name = "RECIEPTQUANTITY")
    public BigDecimal getRecieptquantity() {
        return recieptquantity;
    }

    public void setRecieptquantity(BigDecimal recieptquantity) {
    ...
    public boolean equals(Object o) {
        ...
        DiStocktransactionissue that = (DiStocktransactionissue) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, transactiondate, transactiontime, countercode, code, productionordercode, extcountercode, extcode, extorderline, itemtypecompanycode, itemtypecode, decosubcode01, decosubcode02, decosubcode03, decosubcode04, decosubcode05, decosubcode06, decosubcode07, decosubcode08, decosubcode09, decosubcode10, userprimaryuomcode, userprimaryquantity);
    }
}

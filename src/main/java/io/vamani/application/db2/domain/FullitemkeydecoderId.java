...
public class FullitemkeydecoderId implements Serializable {
    ...
    public FullitemkeydecoderId() {
    }

    public FullitemkeydecoderId(String companycode, String itemtypecode, String subcode01, String subcode02, String subcode03, String subcode04, String subcode05, String subcode06, String subcode07, String subcode08, String subcode09, String subcode10) {
        this.companycode = companycode;
        this.itemtypecode = itemtypecode;
        this.subcode01 = subcode01;
        this.subcode02 = subcode02;
    ...
    public boolean equals(Object o) {
        ...
        FullitemkeydecoderId that = (FullitemkeydecoderId) o;
        return Objects.equals(companycode, that.companycode) && Objects.equals(itemtypecode, that.itemtypecode) && Objects.equals(subcode01, that.subcode01) && Objects.equals(subcode02, that.subcode02) && Objects.equals(subcode03, that.subcode03) && Objects.equals(subcode04, that.subcode04) && Objects.equals(subcode05, that.subcode05) && Objects.equals(subcode06, that.subcode06) && Objects.equals(subcode07, that.subcode07) && Objects.equals(subcode08, that.subcode08) && Objects.equals(subcode09, that.subcode09) && Objects.equals(subcode10, that.subcode10);
    }

    @Override
    public int hashCode() {
        return Objects.hash(companycode, itemtypecode, subcode01, subcode02, subcode03, subcode04, subcode05, subcode06, subcode07, subcode08, subcode09, subcode10);
    }
}

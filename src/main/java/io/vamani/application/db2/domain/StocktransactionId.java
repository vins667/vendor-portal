...
public class StocktransactionId implements Serializable {
    ...
    public StocktransactionId() {
    }

    public StocktransactionId(String companycode, String transactionnumber, Integer transactiondetailnumber) {
        this.companycode = companycode;
        this.transactionnumber = transactionnumber;
        this.transactiondetailnumber = transactiondetailnumber;
    }
    ...
    public boolean equals(Object o) {
        ...
        StocktransactionId that = (StocktransactionId) o;
        return Objects.equals(companycode, that.companycode) && Objects.equals(transactionnumber, that.transactionnumber) && Objects.equals(transactiondetailnumber, that.transactiondetailnumber);
    }

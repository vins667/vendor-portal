...
@Entity
@Table(name = "termsofdelivery")
public class Termsofdelivery {
    @EmbeddedId
    private TermsofdeliveryId id;
    ...
    public TermsofdeliveryId getId() {
        return id;
    }

    public void setId(TermsofdeliveryId id) {
        this.id = id;
    }
    ...
    @Basic
    @Column(name = "TOLERANCEDAYS", nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        Termsofdelivery that = (Termsofdelivery) o;
        return Objects.equals(id, that.id) && Objects.equals(longdescription, that.longdescription) && Objects.equals(shortdescription, that.shortdescription) && Objects.equals(searchdescription, that.searchdescription) && Objects.equals(tolerancedays, that.tolerancedays) && Objects.equals(creationdatetime, that.creationdatetime) && Objects.equals(creationuser, that.creationuser) && Objects.equals(lastupdatedatetime, that.lastupdatedatetime) && Objects.equals(lastupdateuser, that.lastupdateuser) && Objects.equals(absuniqueid, that.absuniqueid) && Objects.equals(creationdatetimeutc, that.creationdatetimeutc) && Objects.equals(lastupdatedatetimeutc, that.lastupdatedatetimeutc);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, longdescription, shortdescription, searchdescription, tolerancedays, creationdatetime, creationuser, lastupdatedatetime, lastupdateuser, absuniqueid, creationdatetimeutc, lastupdatedatetimeutc);
    }
}

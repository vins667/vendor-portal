 ...
 */
@Entity
@Table(name = "cut_plan_bundle_details")
public class CutPlanBundleDetails implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name="cutPlanBundleDetailsSeq", sequenceName="cut_plan_bundle_details_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="cutPlanBundleDetailsSeq")
    private Long id;
    ...
    @NotNull
    @JsonIgnoreProperties("cutPlanBundleDetails")
    @JoinColumn(name = "cut_plan_bundle_id")
    private CutPlanBundle cutPlanBundle;
    ...
    public CutPlanBundleDetails productionCode(String productionCode) {
    ...
    public CutPlanBundleDetails groupstepnumber(Long groupstepnumber) {
    ...
    public CutPlanBundleDetails demandcountercode(String demandcountercode) {
    ...
    public CutPlanBundleDetails demandcode(String demandcode) {
    ...
    public CutPlanBundleDetails itemtypecode(String itemtypecode) {
    ...
    public CutPlanBundleDetails subcode01(String subcode01) {
    ...
    public CutPlanBundleDetails subcode02(String subcode02) {
    ...
    public CutPlanBundleDetails subcode03(String subcode03) {
    ...
    public CutPlanBundleDetails subcode04(String subcode04) {
    ...
    public CutPlanBundleDetails subcode05(String subcode05) {
    ...
    public CutPlanBundleDetails subcode06(String subcode06) {
    ...
    public CutPlanBundleDetails subcode07(String subcode07) {
    ...
    public CutPlanBundleDetails subcode08(String subcode08) {
    ...
    public CutPlanBundleDetails subcode09(String subcode09) {
    ...
    public CutPlanBundleDetails subcode10(String subcode10) {
    ...
    public CutPlanBundleDetails logicalwarehousecode(String logicalwarehousecode) {
    ...
    public CutPlanBundleDetails primaryquantity(Double primaryquantity) {
    ...
    public CutPlanBundleDetails primaryuomcode(String primaryuomcode) {
    ...
    public CutPlanBundleDetails secondaryquantity(Double secondaryquantity) {
    ...
    public CutPlanBundleDetails secondaryuomcode(String secondaryuomcode) {
    ...
    public CutPlanBundleDetails physicalwarehousecode(String physicalwarehousecode) {
    ...
    public CutPlanBundleDetails whslocationwarehousezonecode(String whslocationwarehousezonecode) {
    ...
    public CutPlanBundleDetails warehouselocationcode(String warehouselocationcode) {
    ...
    public CutPlanBundleDetails lotcode(String lotcode) {
    ...
    public CutPlanBundleDetails projectcode(String projectcode) {
    ...
    public CutPlanBundleDetails productCode(String productCode) {
    ...
    public CutPlanBundleDetails createdby(String createdby) {
    ...
    public CutPlanBundleDetails createddate(Instant createddate) {
    ...
    public CutPlanBundleDetails lastupdatedby(String lastupdatedby) {
    ...
    public CutPlanBundleDetails lastupdateddate(Instant lastupdateddate) {
    ...
    public CutPlanBundle getCutPlanBundle() {
        return cutPlanBundle;
    }

    public CutPlanBundleDetails cutPlanBundle(CutPlanBundle cutPlanBundle) {
        this.cutPlanBundle = cutPlanBundle;
        return this;
    }

    public void setCutPlanBundle(CutPlanBundle cutPlanBundle) {
        this.cutPlanBundle = cutPlanBundle;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CutPlanBundleDetails)) {
            return false;
        }
        return id != null && id.equals(((CutPlanBundleDetails) o).id);
    }

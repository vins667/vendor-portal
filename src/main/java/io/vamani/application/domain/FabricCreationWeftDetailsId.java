 ...
 */
public class FabricCreationWeftDetailsId implements Serializable {
    ...
    public FabricCreationWeftDetailsId() {
    }

    public FabricCreationWeftDetailsId(Long id, @NotNull FabricCreationMaster fabricCreationMaster) {
        this.id = id;
        this.fabricCreationMaster = fabricCreationMaster;
    }
    ...
    public boolean equals(Object o) {
        ...
        FabricCreationWeftDetailsId that = (FabricCreationWeftDetailsId) o;
    ...
    public String toString() {
        return "FabricCreationWeftDetailsId{" +
            "id=" + id +

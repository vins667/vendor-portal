 ...
 */
@Entity
@Table(name = "packing_line_issue")
public class PackingLineIssue implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name="packingLineIssueSeq", sequenceName="packing_line_issue_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="packingLineIssueSeq")
    private Long id;
    ...
    public PackingLineIssue plantCode(String plantCode) {
    ...
    public PackingLineIssue plantDescription(String plantDescription) {
    ...
    public PackingLineIssue projectcode(String projectcode) {
    ...
    public PackingLineIssue style(String style) {
        this.style = style;
        return this;
    }
    ...
    public PackingLineIssue color(String color) {
        this.color = color;
        return this;
    }
    ...
    public PackingLineIssue colordescription(String colordescription) {
    ...
    public PackingLineIssue createdby(String createdby) {
    ...
    public PackingLineIssue createddate(Instant createddate) {
    ...
    public PackingLineIssue lastupdatedby(String lastupdatedby) {
    ...
    public PackingLineIssue lastupdateddate(Instant lastupdateddate) {

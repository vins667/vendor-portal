 ...
 */
@Entity
@Table(name = "stitch_issue_pack")
public class StitchIssuePack implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name="stitchIssuePackSeq", sequenceName="stitch_issue_pack_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="stitchIssuePackSeq")
    private Long id;
    ...
    public StitchIssuePack transactionType(String transactionType) {
    ...
    public StitchIssuePack plantCode(String plantCode) {
    ...
    public StitchIssuePack plantDescription(String plantDescription) {
    ...
    public StitchIssuePack destinationPlantCode(String destinationPlantCode) {
    ...
    public StitchIssuePack destinationPlantDescription(String destinationPlantDescription) {
    ...
    public StitchIssuePack projectcode(String projectcode) {
    ...
    public StitchIssuePack style(String style) {
        this.style = style;
        return this;
    }
    ...
    public StitchIssuePack color(String color) {
        this.color = color;
        return this;
    }
    ...
    public StitchIssuePack colordescription(String colordescription) {
    ...
    public StitchIssuePack termsofdeliverycode(String termsofdeliverycode) {
    ...
    public StitchIssuePack termsofdeliverydescription(String termsofdeliverydescription) {
    ...
    public StitchIssuePack termsofshippingcode(String termsofshippingcode) {
    ...
    public StitchIssuePack termsofshippingdescription(String termsofshippingdescription) {
    ...
    public StitchIssuePack eway(String eway) {
        this.eway = eway;
        return this;
    }
    ...
    public StitchIssuePack createdby(String createdby) {
    ...
    public StitchIssuePack createddate(Instant createddate) {
    ...
    public StitchIssuePack lastupdatedby(String lastupdatedby) {
    ...
    public StitchIssuePack lastupdateddate(Instant lastupdateddate) {
...
// jhipster-needle-entity-add-getters-setters - JHipster will add getters and setters here, do not remove
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StitchIssuePack)) {
            return false;
        }
        return id != null && id.equals(((StitchIssuePack) o).id);
    }

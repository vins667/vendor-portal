 ...
 */
@Entity
@Table(name = "stitch_issue_pack_transaction")
public class StitchIssuePackTransaction implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name="stitchIssuePackTransactionSeq", sequenceName="stitch_issue_pack_transaction_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="stitchIssuePackTransactionSeq")
    private Long id;
    ...
    @Column(name = "stitch_issue_pack_id")
    private Long stitchIssuePackId;
    ...
    @Column(name = "packingwarehousecode", length = 20)
    private String packingwarehousecode;
    ...
    public StitchIssuePackTransaction productionCode(String productionCode) {
    ...
    public StitchIssuePackTransaction groupstepnumber(Long groupstepnumber) {
    ...
    public StitchIssuePackTransaction demandcountercode(String demandcountercode) {
    ...
    public StitchIssuePackTransaction demandcode(String demandcode) {
    ...
    public StitchIssuePackTransaction itemtypecode(String itemtypecode) {
    ...
    public StitchIssuePackTransaction subcode01(String subcode01) {
    ...
    public StitchIssuePackTransaction subcode02(String subcode02) {
    ...
    public StitchIssuePackTransaction subcode03(String subcode03) {
    ...
    public StitchIssuePackTransaction subcode04(String subcode04) {
    ...
    public StitchIssuePackTransaction subcode05(String subcode05) {
    ...
    public StitchIssuePackTransaction subcode06(String subcode06) {
    ...
    public StitchIssuePackTransaction subcode07(String subcode07) {
    ...
    public StitchIssuePackTransaction subcode08(String subcode08) {
    ...
    public StitchIssuePackTransaction subcode09(String subcode09) {
    ...
    public StitchIssuePackTransaction subcode10(String subcode10) {
    ...
    public StitchIssuePackTransaction logicalwarehousecode(String logicalwarehousecode) {
    ...
    public StitchIssuePackTransaction primaryquantity(Double primaryquantity) {
    ...
    public StitchIssuePackTransaction primaryuomcode(String primaryuomcode) {
    ...
    public StitchIssuePackTransaction secondaryquantity(Double secondaryquantity) {
    ...
    public StitchIssuePackTransaction secondaryuomcode(String secondaryuomcode) {
    ...
    public StitchIssuePackTransaction physicalwarehousecode(String physicalwarehousecode) {
    ...
    public StitchIssuePackTransaction whslocationwarehousezonecode(String whslocationwarehousezonecode) {
    ...
    public StitchIssuePackTransaction warehouselocationcode(String warehouselocationcode) {
    ...
    public StitchIssuePackTransaction lotcode(String lotcode) {
    ...
    public StitchIssuePackTransaction projectcode(String projectcode) {
    ...
    public StitchIssuePackTransaction productCode(String productCode) {
    ...
    public StitchIssuePackTransaction createdby(String createdby) {
    ...
    public StitchIssuePackTransaction createddate(Instant createddate) {
    ...
    public StitchIssuePackTransaction lastupdatedby(String lastupdatedby) {
    ...
    public StitchIssuePackTransaction lastupdateddate(Instant lastupdateddate) {
    ...
    public Long getStitchIssuePackId() {
        return stitchIssuePackId;
    }

    public void setStitchIssuePackId(Long stitchIssuePackId) {
        this.stitchIssuePackId = stitchIssuePackId;
    }
    ...
    public String getPackingwarehousecode() {
        return packingwarehousecode;
    }

    public void setPackingwarehousecode(String packingwarehousecode) {
        this.packingwarehousecode = packingwarehousecode;
    }
// jhipster-needle-entity-add-getters-setters - JHipster will add getters and setters here, do not remove
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StitchIssuePackTransaction)) {
            return false;
        }
        return id != null && id.equals(((StitchIssuePackTransaction) o).id);
    }

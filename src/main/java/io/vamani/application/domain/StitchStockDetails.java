 ...
 */
@Entity
@Table(name = "stitch_stock_details")
public class StitchStockDetails implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name="stitchStockDetailsSeq", sequenceName="stitch_stock_details_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="stitchStockDetailsSeq")
    private Long id;
    ...
    public StitchStockDetails productionCode(String productionCode) {
    ...
    public StitchStockDetails groupstepnumber(Long groupstepnumber) {
    ...
    public StitchStockDetails demandcountercode(String demandcountercode) {
    ...
    public StitchStockDetails demandcode(String demandcode) {
    ...
    public StitchStockDetails itemtypecode(String itemtypecode) {
    ...
    public StitchStockDetails subcode01(String subcode01) {
    ...
    public StitchStockDetails subcode02(String subcode02) {
    ...
    public StitchStockDetails subcode03(String subcode03) {
    ...
    public StitchStockDetails subcode04(String subcode04) {
    ...
    public StitchStockDetails subcode05(String subcode05) {
    ...
    public StitchStockDetails subcode06(String subcode06) {
    ...
    public StitchStockDetails subcode07(String subcode07) {
    ...
    public StitchStockDetails subcode08(String subcode08) {
    ...
    public StitchStockDetails subcode09(String subcode09) {
    ...
    public StitchStockDetails subcode10(String subcode10) {
    ...
    public StitchStockDetails logicalwarehousecode(String logicalwarehousecode) {
    ...
    public StitchStockDetails primaryquantity(Double primaryquantity) {
    ...
    public StitchStockDetails primaryuomcode(String primaryuomcode) {
    ...
    public StitchStockDetails secondaryquantity(Double secondaryquantity) {
    ...
    public StitchStockDetails secondaryuomcode(String secondaryuomcode) {
    ...
    public StitchStockDetails physicalwarehousecode(String physicalwarehousecode) {
    ...
    public StitchStockDetails whslocationwarehousezonecode(String whslocationwarehousezonecode) {
    ...
    public StitchStockDetails warehouselocationcode(String warehouselocationcode) {
    ...
    public StitchStockDetails lotcode(String lotcode) {
    ...
    public StitchStockDetails projectcode(String projectcode) {
    ...
    public StitchStockDetails productCode(String productCode) {
    ...
    public StitchStockDetails createdby(String createdby) {
    ...
    public StitchStockDetails createddate(Instant createddate) {
    ...
    public StitchStockDetails lastupdatedby(String lastupdatedby) {
    ...
    public StitchStockDetails lastupdateddate(Instant lastupdateddate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StitchStockDetails)) {
            return false;
        }
        return id != null && id.equals(((StitchStockDetails) o).id);
    }

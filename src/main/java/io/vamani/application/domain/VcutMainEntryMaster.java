...
public class VcutMainEntryMaster implements Serializable {
    ...
    @NotNull
    @JoinColumn(name = "vcut_style_plan_upload_id")
    private VcutStylePlanUpload vcutStylePlanUpload;

    @ManyToOne
    @JsonIgnoreProperties("vcutMainEntryMasters")
    @JoinColumn(name = "vcut_operation_master_id")
    private VcutOperationMaster vcutOperationMaster;
    ...
    public VcutMainEntryMaster entryType(String entryType) {
    ...
    public VcutMainEntryMaster entryTime(Instant entryTime) {
    ...
    public VcutMainEntryMaster entryBy(String entryBy) {
    ...
    public VcutMainEntryMaster rectifiedBy(String rectifiedBy) {
    ...
    public VcutMainEntryMaster rectifiedDate(Instant rectifiedDate) {
    ...
    public VcutStylePlanUpload getVcutStylePlanUpload() {
        return vcutStylePlanUpload;
    }

    public VcutMainEntryMaster vcutStylePlanUpload(VcutStylePlanUpload vcutStylePlanUpload) {
        this.vcutStylePlanUpload = vcutStylePlanUpload;
        return this;
    }

    public void setVcutStylePlanUpload(VcutStylePlanUpload vcutStylePlanUpload) {
        this.vcutStylePlanUpload = vcutStylePlanUpload;
    }

    public VcutOperationMaster getVcutOperationMaster() {
        return vcutOperationMaster;
    }

    public VcutMainEntryMaster vcutOperationMaster(VcutOperationMaster vcutOperationMaster) {
        this.vcutOperationMaster = vcutOperationMaster;
        return this;
    }

    public void setVcutOperationMaster(VcutOperationMaster vcutOperationMaster) {
        this.vcutOperationMaster = vcutOperationMaster;
    }
...
// jhipster-needle-entity-add-getters-setters - JHipster will add getters and setters here, do not remove
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof VcutMainEntryMaster)) {
            return false;
        }
        return id != null && id.equals(((VcutMainEntryMaster) o).id);
    }

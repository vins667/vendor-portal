...
public class CutPlanIssueStitchBean implements Serializable {
    private Long id;
    ...
    private List<CutIssueStitchDetailsBean> cutIssueStitchDetails;
    ...
    public List<CutIssueStitchDetailsBean> getCutIssueStitchDetails() {
        return cutIssueStitchDetails;
    }

    public void setCutIssueStitchDetails(List<CutIssueStitchDetailsBean> cutIssueStitchDetails) {
        this.cutIssueStitchDetails = cutIssueStitchDetails;
    }
}

...
/**
 * A VendorAdditionalInfoTransaction.
 */
@Entity
@Table(name = "vendor_additional_info_transaction")
public class VendorAdditionalInfoTransaction implements Serializable {

    private static final long serialVersionUID = 1L;
    
    @Id
    @SequenceGenerator(name="vendorAdditionalTransSeq", sequenceName="vendor_additional_info_trans_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="vendorAdditionalTransSeq")
    private Long id;
    ...
    public VendorAdditionalInfoTransaction vendorId(Long vendorId) {
    ...
    public VendorAdditionalInfoTransaction esiCode(String esiCode) {
    ...
    public VendorAdditionalInfoTransaction pfCode(String pfCode) {
        this.pfCode = pfCode;
        return this;
    }
    ...
    public VendorAdditionalInfoTransaction isSsiUnit(Boolean isSsiUnit) {
    ...
    public VendorAdditionalInfoTransaction propPartnerDirector(String propPartnerDirector) {
    ...
    public VendorAdditionalInfoTransaction propPtrnDtrTeleNo(String propPtrnDtrTeleNo) {
    ...
    public VendorAdditionalInfoTransaction associateSisterConcern(String associateSisterConcern) {
    ...
    public VendorAdditionalInfoTransaction introducedBy(String introducedBy) {
    ...
    public VendorAdditionalInfoTransaction comp_ref(String comp_ref) {
    ...
    public VendorAdditionalInfoTransaction productServiceItemsOfParty(String productServiceItemsOfParty) {
    ...
    public VendorAdditionalInfoTransaction manufacturigUnitAddress(String manufacturigUnitAddress) {
    ...
    public VendorAdditionalInfoTransaction manufacturingUnitCapicity(String manufacturingUnitCapicity) {
    ...
    public VendorAdditionalInfoTransaction numberOfMachines(Long numberOfMachines) {
    ...
    public VendorAdditionalInfoTransaction numberOfEmployees(Long numberOfEmployees) {
    ...
    public VendorAdditionalInfoTransaction dealingWithOthExptParty(String dealingWithOthExptParty) {
    ...
    public VendorAdditionalInfoTransaction turnoverId(Long turnoverId) {
    ...
    public VendorAdditionalInfoTransaction auditor(String auditor) {
    ...
    public VendorAdditionalInfoTransaction auditorAddress(String auditorAddress) {
    ...
    public VendorAdditionalInfoTransaction personDealingWithCompany(String personDealingWithCompany) {
    ...
    public VendorAdditionalInfoTransaction department(String department) {
    ...
    public VendorAdditionalInfoTransaction remarks(String remarks) {
    ...
    public VendorAdditionalInfoTransaction createdBy(String createdBy) {
    ...
    public VendorAdditionalInfoTransaction createdDate(Instant createdDate) {
    ...
    public VendorAdditionalInfoTransaction lastUpdatedBy(String lastUpdatedBy) {
    ...
    public VendorAdditionalInfoTransaction lastUpdatedDate(Instant lastUpdatedDate) {
    ...
    public VendorAdditionalInfoTransaction approvedDate(Instant approvedDate) {
...
// jhipster-needle-entity-add-getters-setters - JHipster will add getters and setters here, do not remove
    ...
    public boolean equals(Object o) {
        ...
        VendorAdditionalInfoTransaction vendorAdditionalInfoTransaction = (VendorAdditionalInfoTransaction) o;
        if (vendorAdditionalInfoTransaction.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), vendorAdditionalInfoTransaction.getId());
    }
    ...
    public String toString() {
        return "VendorAdditionalInfoTransaction{" +
            "id=" + getId() +

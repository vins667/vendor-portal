...
/**
 * A VendorBranchDetailsTransaction.
 */
@Entity
@Table(name = "vendor_branch_details_transaction")
public class VendorBranchDetailsTransaction implements Serializable {

    private static final long serialVersionUID = 1L;
    
    @Id
    @SequenceGenerator(name="vendorBranchDetailsTransSeq", sequenceName="vendor_branch_details_trans_seq", allocationSize=1)
    @GeneratedValue(strategy=GenerationType.AUTO, generator="vendorBranchDetailsTransSeq")
    private Long id;
    ...
    public VendorBranchDetailsTransaction vendorId(Long vendorId) {
    ...
    public VendorBranchDetailsTransaction addressLine1(String addressLine1) {
    ...
    public VendorBranchDetailsTransaction addressLine2(String addressLine2) {
    ...
    public VendorBranchDetailsTransaction addressLine3(String addressLine3) {
    ...
    public VendorBranchDetailsTransaction addressLine4(String addressLine4) {
    ...
    public VendorBranchDetailsTransaction countryId(Long countryId) {
    ...
    public VendorBranchDetailsTransaction stateId(Long stateId) {
    ...
    public VendorBranchDetailsTransaction pincode(Long pincode) {
    ...
    public VendorBranchDetailsTransaction addressForTax(Boolean addressForTax) {
    ...
    public VendorBranchDetailsTransaction registeredForSaleTax(Boolean registeredForSaleTax) {
    ...
    public VendorBranchDetailsTransaction salesTaxVatTinNumber(String salesTaxVatTinNumber) {
    ...
    public VendorBranchDetailsTransaction registeredServiceTax(Boolean registeredServiceTax) {
    ...
    public VendorBranchDetailsTransaction serviceTaxNumber(String serviceTaxNumber) {
    ...
    public VendorBranchDetailsTransaction exciseApplicable(Boolean exciseApplicable) {
    ...
    public VendorBranchDetailsTransaction exciseRegistrationNumber(String exciseRegistrationNumber) {
    ...
    public VendorBranchDetailsTransaction exciseRange(String exciseRange) {
    ...
    public VendorBranchDetailsTransaction exciseDivision(String exciseDivision) {
    ...
    public VendorBranchDetailsTransaction exciseAddressLine1(String exciseAddressLine1) {
    ...
    public VendorBranchDetailsTransaction exciseAddressLine2(String exciseAddressLine2) {
    ...
    public VendorBranchDetailsTransaction divisionAddressLine1(String divisionAddressLine1) {
    ...
    public VendorBranchDetailsTransaction divisionAddressLine2(String divisionAddressLine2) {
    ...
    public VendorBranchDetailsTransaction gstNumber(String gstNumber) {
    ...
    public VendorBranchDetailsTransaction gstApplicable(Boolean gstApplicable) {
    ...
    public VendorBranchDetailsTransaction vendTypeMasterId(Long vendTypeMasterId) {
    ...
    public VendorBranchDetailsTransaction vendSubTypeMasterId(Long vendSubTypeMasterId) {
    ...
    public VendorBranchDetailsTransaction addressId(String addressId) {
    ...
    public VendorBranchDetailsTransaction createdBy(String createdBy) {
    ...
    public VendorBranchDetailsTransaction createdDate(Instant createdDate) {
    ...
    public VendorBranchDetailsTransaction lastUpdatedBy(String lastUpdatedBy) {
    ...
    public VendorBranchDetailsTransaction lastUpdatedDate(Instant lastUpdatedDate) {
    ...
    public VendorBranchDetailsTransaction approvedDate(Instant approvedDate) {
...
// jhipster-needle-entity-add-getters-setters - JHipster will add getters and setters here, do not remove
    ...
    public boolean equals(Object o) {
        ...
        VendorBranchDetailsTransaction vendorBranchDetailsTransaction = (VendorBranchDetailsTransaction) o;
        if (vendorBranchDetailsTransaction.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), vendorBranchDetailsTransaction.getId());
    }
    ...
    public String toString() {
        return "VendorBranchDetailsTransaction{" +
            "id=" + getId() +

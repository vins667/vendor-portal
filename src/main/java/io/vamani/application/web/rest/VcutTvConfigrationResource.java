...
@RestController
@RequestMapping("/tv")
public class VcutTvConfigrationResource {

    private final Logger log = LoggerFactory.getLogger(VcutTvConfigrationResource.class);
    ...
    public VcutTvConfigrationResource(VcutTvConfigrationRepository vcutTvConfigrationRepository) {
     ...
     */
    @GetMapping("/vcut-tv-configrations/{line}")
    public ResponseEntity<List<VcutTvConfigration>> getAllVcutTvConfigrations(@PathVariable String line) {
        log.debug("REST request to get a page of VcutTvConfigrations");
        List<VcutTvConfigration> page = vcutTvConfigrationRepository.findByLine(line);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vcutStylePlanUploads in body.
     */
    @GetMapping("/vcut-tv-dashboard/{line}")
    public ResponseEntity<VcutTvDashboard> getAllVcutTvDashboard(@PathVariable String line) throws ParseException {
        log.debug("REST request to get a page of VcutTvConfigrations");
        VcutTvDashboard vcutTvDashboard = new VcutTvDashboard();
        LocalDate now = new Date().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        VcutStylePlanUpload vcutStylePlanUpload = vcutStylePlanUploadRepository.findByLineNoAndActivePlan(now, line);
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vcutStylePlanUploads in body.
     */
    @GetMapping("/vcut-tv-line-summary/{line}")
    public ResponseEntity<VcutTvLineSummary> getAllVcutLineSummary(@PathVariable String line) throws ParseException {
        log.debug("REST request to get a page of VcutTvConfigrations");
        VcutTvLineSummary vcutTvLineSummary = new VcutTvLineSummary();
        Date planDate = new Date();
        LocalDate now = planDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vcutStylePlanUploads in body.
     */
    @GetMapping("/vcut-tv-defect-summary/{line}")
    public ResponseEntity<VcutTvDefectSummary> getAllVcutDefectSummary(@PathVariable String line) throws ParseException {
        log.debug("REST request to get a page of VcutTvConfigrations");
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vcutStylePlanUploads in body.
     */
    @GetMapping("/vcut-tv-defect-operation-summary/{line}")
    public ResponseEntity<VcutTvDefectSummary> getAllVcutDefectOperationSummary(@PathVariable String line) throws ParseException {
        log.debug("REST request to get a page of VcutTvConfigrations");
        VcutTvDefectSummary vcutTvDefectSummary = new VcutTvDefectSummary();
        Date planDate = new Date();
        LocalDate now = planDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of vcutStylePlanUploads in body.
     */
    @GetMapping("/vcut-tv-image-summary/{line}")
    public ResponseEntity<VcutTvImageSummary> getAllVcutImageSummary(@PathVariable String line) throws ParseException, NoSuchAlgorithmException {
        log.debug("REST request to get a page of VcutTvConfigrations");

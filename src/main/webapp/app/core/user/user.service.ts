...
export class UserService {
  ...
  private resourceUrlAgree = SERVER_API_URL + 'api/current-users-agree';
  ...
  agree(req?: any): Observable<HttpResponse<IUser>> {
    return this.http.get<IUser>(this.resourceUrlAgree, { observe: 'response' });
  }
}

...
@Component({
  selector: 'jhi-cut-plan-bundle',
  templateUrl: './cut-plan-bundle.component.html'
})
export class CutPlanBundleComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: ICutPlanEntry): any {
  ...
  fetchView(cutPlanEntry?: ICutPlanEntry): void {
    this.cutPlanEntryService.cutPlanEntry = cutPlanEntry;
    this.router.navigate(['/cut-plan-bundle/edit']);
  }
}

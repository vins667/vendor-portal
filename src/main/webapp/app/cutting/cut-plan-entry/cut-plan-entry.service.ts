...
export class CutPlanEntryService {
  ...
  public resourceUrlSuggestionMarker = SERVER_API_URL + 'api/balance-suggestions-marker';
  ...
  suggestionMarker(search?: IBalanceSuggestionSearch): Observable<HttpResponse<ILotBean[]>> {
    return this.http.post<ILotBean[]>(this.resourceUrlSuggestionMarker, search, { observe: 'response' });
  }

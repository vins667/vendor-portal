...
@Component({
  selector: 'jhi-cut-sch-productionorder-selection-entry',
  templateUrl: './cut-sch-productionorder-selection.component.html'
})
export class CutSchProductionorderSelectionComponent implements OnInit {
  isSaving = false;
  isProcess = false;

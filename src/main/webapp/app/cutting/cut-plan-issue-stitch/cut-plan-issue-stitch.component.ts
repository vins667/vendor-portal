...
@Component({
  selector: 'jhi-cut-plan-issue-stitch',
  templateUrl: './cut-plan-issue-stitch.component.html'
})
export class CutPlanIssueStitchComponent implements OnInit, OnDestroy {
  ...
  delete(cutPlanIssueStitch: ICutPlanIssueStitch): void {
    const modalRef = this.modalService.open(CutPlanIssueStitchDeleteDialogComponent, { size: 'lg', backdrop: 'static' });

...
export class CutPlanRecieptStitchService {
  public resourceUrl = SERVER_API_URL + 'api/cut-plan-reciept-stitches';
  public resourceUrlDetails = SERVER_API_URL + 'api/cut-issue-stitch-details';
  public resourceUrlFilter = SERVER_API_URL + 'api/cut-plan-reciept-stitches-filter';

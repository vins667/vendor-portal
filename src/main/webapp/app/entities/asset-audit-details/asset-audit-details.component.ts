...
@Component({
  selector: 'jhi-asset-audit-details',
  templateUrl: './asset-audit-details.component.html'
})
export class AssetAuditDetailsComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  transition() {
    this.router.navigate(['/asset-audit-details'], {
      queryParams: {
        page: this.page,

...
export class LeaveMasterService {
  ...
  public resourceUrlMobile = SERVER_API_URL + 'api/mobile-attendances-date';
  public resourceUrlCompOff = SERVER_API_URL + 'api/comp-off-masters-leave';
  ...
  mobile(req?: ILeaveSearch): Observable<HttpResponse<IMobileAttendance[]>> {
    return this.http.post<IMobileAttendance[]>(`${this.resourceUrlMobile}`, req, { observe: 'response' });
  }

  compOff(): Observable<HttpResponse<ICompOffLeave[]>> {
    return this.http.get<ICompOffLeave[]>(`${this.resourceUrlCompOff}`, { observe: 'response' });
  }

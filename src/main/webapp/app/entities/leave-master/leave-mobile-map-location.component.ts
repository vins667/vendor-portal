...
@Component({
  selector: 'jhi-leave-mobile-map-location',
  templateUrl: 'leave-mobile-map-location.component.html',
  styleUrls: ['leave-mobile-map-location.component.scss']
})
export class LeaveMobileMapLocationComponent implements OnInit {

...
@Component({
  selector: 'jhi-news-details-approval',
  templateUrl: './news-details-approval.component.html',
  encapsulation: ViewEncapsulation.None
})
export class NewsDetailsApprovalComponent implements OnInit, OnDestroy {
  currentAccount: any;

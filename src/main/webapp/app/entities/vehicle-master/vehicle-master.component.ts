...
@Component({
  selector: 'jhi-vehicle-master',
  templateUrl: './vehicle-master.component.html'
})
export class VehicleMasterComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  loadAll() {
    this.vehicleMasterService
      ...
      .subscribe(
        (res: HttpResponse<IVehicleMaster[]>) => this.paginateVehicleMasters(res.body, res.headers),

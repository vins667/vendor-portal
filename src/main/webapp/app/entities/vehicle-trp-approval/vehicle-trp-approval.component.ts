...
@Component({
  selector: 'jhi-vehicle-trp-approval',
  templateUrl: './vehicle-trp-approval.component.html',
  providers: [
...
export class VehicleTrpApprovalComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  loadAll() {
    ...
    this.vehicleMasterService
      .queryTransport(this.leavesearch)
      .subscribe(

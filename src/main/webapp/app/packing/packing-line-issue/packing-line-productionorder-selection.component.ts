...
@Component({
  selector: 'jhi-packing-line-productionorder-selection',
  templateUrl: './packing-line-productionorder-selection.component.html'
})
export class PackingLineProductionorderSelectionComponent implements OnInit {
  isSaving = false;
  isProcess = false;
  ...
  constructor(
    ...
    public packingLineIssueService: PackingLineIssueService
  ) {

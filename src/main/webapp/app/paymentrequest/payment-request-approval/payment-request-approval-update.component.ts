...
@Component({
  selector: 'jhi-payment-request-approval-update',
  templateUrl: './payment-request-approval-update.component.html',
...
export class PaymentRequestApprovalUpdateComponent implements OnInit {
  currentAccount: any;
  isSaving: boolean;
  isInvoice = false;
  companies?: ICompany[];
  ...
  constructor(
    ...
    protected paymentRequestApprovalService: PaymentRequestApprovalService,
  ...
  protected onSaveSuccess() {
    ...
    this.paymentRequestApprovalService.find(this.editForm.controls['id'].value).subscribe(paymentRequestForm => {
      this.updateForm(paymentRequestForm.body);
      this.paymentRequestFormDetails = paymentRequestForm.body.paymentRequestFormDetails;
      this.paymentRequestFormDetail = paymentRequestForm.body.paymentRequestFormDetail;
      this.forwards = paymentRequestForm.body.forwards;

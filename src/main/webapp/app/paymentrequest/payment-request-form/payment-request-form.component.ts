...
@Component({
  selector: 'jhi-payment-request-form',
...
export class PaymentRequestFormComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.paymentRequestFormService
      ...
      .subscribe((res: HttpResponse<IPaymentRequestForm[]>) => this.onSuccess(res.body, res.headers, pageToLoad), () => this.onError());
  }
  ...
  protected onSuccess(data: IPaymentRequestForm[] | null, headers: HttpHeaders, page: number): void {
    ...
    this.page = page;
    this.router.navigate(['/payment-request-form'], {
      queryParams: {
        page: this.page,

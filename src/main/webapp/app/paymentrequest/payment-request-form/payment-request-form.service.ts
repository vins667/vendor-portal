...
import { ICurrencydailyexchangerate } from './currencydailyexchangerate.model';
...
export class PaymentRequestFormService {
  public resourceUrl = SERVER_API_URL + 'api/payment-request-forms';
  ...
  public resourceUrlJobwork = SERVER_API_URL + 'api/db2-jobworks/';
  public resourceUrlPurchaseinvoice = SERVER_API_URL + 'api/purchaseinvoices/';
  ...
  public resourceUrlPrint = SERVER_API_URL + 'api/db2-purchase-order';
  public resourceUrlExchangeRate = SERVER_API_URL + 'api/db2-fetch-exchange-rate';
  ...
  downloadPDF(poNo: string, templateType: string): Observable<Blob> {
    const search = new MasterSearch();
    search.reportType = 'PDF';
    search.templateType = templateType;
    search.parameters1 = [];
    search.parameters1.push(poNo);
    return this.http.post(this.resourceUrlPrint, search, { responseType: 'blob' });
  }

  exchangeRate(currencycode: string): Observable<HttpResponse<ICurrencydailyexchangerate>> {
    return this.http.get<ICurrencydailyexchangerate>(`${this.resourceUrlExchangeRate}/${currencycode}`, { observe: 'response' });
  }

...
@Component({
  selector: 'jhi-payreq-employee-search-search',
  templateUrl: './employee-search.component.html'
})
export class PayReqEmployeeSearchComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  addData(employeeView) {
    this.eventManager.broadcast({ name: 'selectedPayReqUserLinkCreation', content: employeeView });
    this.activeModal.dismiss('cancel');
  }
}

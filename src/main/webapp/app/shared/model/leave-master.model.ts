...
import { IMobileAttendance } from './mobile-attendance.model';
...
export interface ILeaveMaster {
  ...
  compOffMasterId?: number;
  mobileAttendances?: IMobileAttendance[];
}

export class LeaveMaster implements ILeaveMaster {
  constructor(
    public id?: number,
    ...
    public compOffMasterId?: number,
    public mobileAttendanceId?: number[]
  ) {}
}

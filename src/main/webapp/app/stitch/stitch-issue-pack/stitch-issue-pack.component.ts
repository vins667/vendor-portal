...
@Component({
  selector: 'jhi-stitch-issue-pack',
  templateUrl: './stitch-issue-pack.component.html'
})
export class StitchIssuePackComponent implements OnInit, OnDestroy {
  ...
  delete(stitchIssuePack: IStitchIssuePack): void {
    const modalRef = this.modalService.open(StitchIssuePackDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.stitchIssuePack = stitchIssuePack;
  }

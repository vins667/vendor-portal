...
export class StitchIssuePackService {
  public resourceUrl = SERVER_API_URL + 'api/stitch-issue-packs';
  public resourceUrlDetails = SERVER_API_URL + 'api/stitch-issue-pack-details';
  public resourceUrlFilter = SERVER_API_URL + 'api/stitch-issue-packs-filter';
  public resourceUrlFilterBundle = SERVER_API_URL + 'api/stitch-stock-details-bundle';
  public resourceUrlFilterPiece = SERVER_API_URL + 'api/stitch-stock-details-piece';
  ...
  public resourceUrlPdf = SERVER_API_URL + 'api/stitch-issue-packs-pdf';

...
@Component({
  selector: 'jhi-vendor-buyer-master-content-search',
  templateUrl: './vendor-buyer-master-search.component.html'
})
export class VendorBuyerMasterSearchComponent implements OnInit, OnDestroy {
  currentAccount: any;
  ...
  constructor(
    protected vendorMasterService: VendorBuyerAuditService,
  ...
  addData(fabricContentMaster) {
    this.eventManager.broadcast({ name: 'selectedVendorBuyerMasterBuyerLink', content: fabricContentMaster });
